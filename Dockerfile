...
RUN dnf update; \\
    ...
    mkdir /opt; \\
    cd /opt; \\
    wget -O graalvm-quarkus.tar.gz https://github.com/graalvm/mandrel/releases/download/mandrel-__mandrel_version__/mandrel-java__java_version__-linux-amd64-__mandrel_version__.tar.gz; \\
